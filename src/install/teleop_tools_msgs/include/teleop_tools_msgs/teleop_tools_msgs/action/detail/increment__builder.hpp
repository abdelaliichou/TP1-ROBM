...
class Init_Increment_SendGoal_Event_response
{
public:
  explicit Init_Increment_SendGoal_Event_response(::teleop_tools_msgs::action::Increment_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::teleop_tools_msgs::action::Increment_SendGoal_Event response(::teleop_tools_msgs::action::Increment_SendGoal_Event::_response_type arg)
  {
...
private:
  ::teleop_tools_msgs::action::Increment_SendGoal_Event msg_;
};

class Init_Increment_SendGoal_Event_request
{
public:
  explicit Init_Increment_SendGoal_Event_request(::teleop_tools_msgs::action::Increment_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Increment_SendGoal_Event_response request(::teleop_tools_msgs::action::Increment_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Increment_SendGoal_Event_response(msg_);
  }
...
class Init_Increment_SendGoal_Event_info
{
public:
  Init_Increment_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Increment_SendGoal_Event_request info(::teleop_tools_msgs::action::Increment_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Increment_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::teleop_tools_msgs::action::Increment_SendGoal_Event>()
{
  return teleop_tools_msgs::action::builder::Init_Increment_SendGoal_Event_info();
}
...
class Init_Increment_GetResult_Event_response
{
public:
  explicit Init_Increment_GetResult_Event_response(::teleop_tools_msgs::action::Increment_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::teleop_tools_msgs::action::Increment_GetResult_Event response(::teleop_tools_msgs::action::Increment_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::teleop_tools_msgs::action::Increment_GetResult_Event msg_;
};

class Init_Increment_GetResult_Event_request
{
public:
  explicit Init_Increment_GetResult_Event_request(::teleop_tools_msgs::action::Increment_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Increment_GetResult_Event_response request(::teleop_tools_msgs::action::Increment_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Increment_GetResult_Event_response(msg_);
  }
...
class Init_Increment_GetResult_Event_info
{
public:
  Init_Increment_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Increment_GetResult_Event_request info(::teleop_tools_msgs::action::Increment_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Increment_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::teleop_tools_msgs::action::Increment_GetResult_Event>()
{
  return teleop_tools_msgs::action::builder::Init_Increment_GetResult_Event_info();
}
