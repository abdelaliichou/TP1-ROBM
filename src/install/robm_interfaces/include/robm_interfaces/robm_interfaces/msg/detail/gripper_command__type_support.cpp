...
{
  new (message_memory) robm_interfaces::msg::GripperCommand(_init);
}

void GripperCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robm_interfaces::msg::GripperCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperCommand_message_member_array[1] = {
  {
    ...
    offsetof(robm_interfaces::msg::GripperCommand, position),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperCommand_message_members = {
  ...
  1,  // number of fields
  sizeof(robm_interfaces::msg::GripperCommand),
...
{
  return &::robm_interfaces::msg::rosidl_typesupport_introspection_cpp::GripperCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robm_interfaces, msg, GripperCommand)() {
  return &::robm_interfaces::msg::rosidl_typesupport_introspection_cpp::GripperCommand_message_type_support_handle;
}
