...
{
  new (message_memory) robm_interfaces::msg::ServoCommand(_init);
}

void ServoCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robm_interfaces::msg::ServoCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServoCommand_message_member_array[1] = {
  {
    ...
    offsetof(robm_interfaces::msg::ServoCommand, angle),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServoCommand_message_members = {
  ...
  1,  // number of fields
  sizeof(robm_interfaces::msg::ServoCommand),
...
{
  return &::robm_interfaces::msg::rosidl_typesupport_introspection_cpp::ServoCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robm_interfaces, msg, ServoCommand)() {
  return &::robm_interfaces::msg::rosidl_typesupport_introspection_cpp::ServoCommand_message_type_support_handle;
}
