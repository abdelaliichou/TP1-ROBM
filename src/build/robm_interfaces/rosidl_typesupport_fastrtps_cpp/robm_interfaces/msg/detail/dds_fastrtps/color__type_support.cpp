...
#include "robm_interfaces/msg/detail/color__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robm_interfaces::msg::Color & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robm_interfaces::msg::Color & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robm_interfaces::msg::Color;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robm_interfaces::msg::Color *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robm_interfaces::msg::Color *>(
    untyped_ros_message);
...
{
  return &robm_interfaces::msg::typesupport_fastrtps_cpp::_Color__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robm_interfaces, msg, Color)() {
  return &robm_interfaces::msg::typesupport_fastrtps_cpp::_Color__handle;
}
