...
#include "robm_interfaces/msg/detail/gripper_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robm_interfaces::msg::GripperCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robm_interfaces::msg::GripperCommand & ros_message)
{
  // Member: position
  cdr >> ros_message.position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robm_interfaces::msg::GripperCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robm_interfaces
max_serialized_size_key_GripperCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const robm_interfaces::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robm_interfaces::msg::GripperCommand *>(
    untyped_ros_message);
...
get_message_type_support_handle<robm_interfaces::msg::GripperCommand>()
{
  return &robm_interfaces::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robm_interfaces, msg, GripperCommand)() {
  return &robm_interfaces::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
