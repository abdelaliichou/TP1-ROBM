...
#include "robm_interfaces/msg/detail/servo_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robm_interfaces::msg::ServoCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robm_interfaces::msg::ServoCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robm_interfaces::msg::ServoCommand *>(
    untyped_ros_message);
...
{
  return &robm_interfaces::msg::typesupport_fastrtps_cpp::_ServoCommand__handle;
}
