...
enum
{
  teleop_tools_msgs__action__Increment_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  teleop_tools_msgs__action__Increment_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Increment in the package teleop_tools_msgs.
typedef struct teleop_tools_msgs__action__Increment_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  teleop_tools_msgs__action__Increment_SendGoal_Request__Sequence request;
  teleop_tools_msgs__action__Increment_SendGoal_Response__Sequence response;
} teleop_tools_msgs__action__Increment_SendGoal_Event;

// Struct for a sequence of teleop_tools_msgs__action__Increment_SendGoal_Event.
typedef struct teleop_tools_msgs__action__Increment_SendGoal_Event__Sequence
{
...
enum
{
  teleop_tools_msgs__action__Increment_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  teleop_tools_msgs__action__Increment_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Increment in the package teleop_tools_msgs.
typedef struct teleop_tools_msgs__action__Increment_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  teleop_tools_msgs__action__Increment_GetResult_Request__Sequence request;
  teleop_tools_msgs__action__Increment_GetResult_Response__Sequence response;
} teleop_tools_msgs__action__Increment_GetResult_Event;

// Struct for a sequence of teleop_tools_msgs__action__Increment_GetResult_Event.
typedef struct teleop_tools_msgs__action__Increment_GetResult_Event__Sequence
{
