...
template<>
inline const char * data_type<teleop_tools_msgs::action::Increment>()
{
  return "teleop_tools_msgs::action::Increment";
}

template<>
inline const char * name<teleop_tools_msgs::action::Increment>()
{
  return "teleop_tools_msgs/action/Increment";
}
