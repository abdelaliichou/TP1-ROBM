...
#include "robm_interfaces/msg/detail/gripper_command__rosidl_typesupport_fastrtps_c.h"
...
using _GripperCommand__ros_msg_type = robm_interfaces__msg__GripperCommand;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robm_interfaces__msg__GripperCommand;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robm_interfaces__msg__GripperCommand * ros_message = static_cast<const robm_interfaces__msg__GripperCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robm_interfaces__msg__GripperCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robm_interfaces__msg__GripperCommand * ros_message = static_cast<robm_interfaces__msg__GripperCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robm_interfaces__msg__GripperCommand(cdr, ros_message);
}

static uint32_t _GripperCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robm_interfaces__msg__GripperCommand(
...
static size_t _GripperCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robm_interfaces__msg__GripperCommand(
